...
Blazor is a web development framework for building web UIs, desktop apps, and mobile apps with .NET.
...
Blazor is developed by Microsoft as part of the ASP.NET Core project and is governed by [The .NET Foundation](https://dotnetfoundation.org/), a non-profit organization created for
